...
>
  ...
  <span className="sr-only">Toggle Complete</span>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="w-[95%] sm:max-w-162.5 p-0 border-none bg-transparent shadow-none overflow-visible">
          ...
          <div className="absolute inset-0 bg-linear-to-r from-indigo-400/20 via-pink-300/20 to-rose-400/20 blur-[120px] animate-pulse -z-10" />
