...
def get_notification_consumer_config() -> ConsumerConfig:
    """Get Kafka configuration for notification service."""
    return ConsumerConfig(
        bootstrap_servers=os.getenv("KAFKA_BOOTSTRAP_SERVERS", "localhost:9092"),
        group_id=os.getenv("KAFKA_CONSUMER_GROUP_ID", "notification-service"),
        topic_name=os.getenv("KAFKA_TOPIC_NAME", "reminders"),
